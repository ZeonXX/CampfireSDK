...
( #sit ) Добавил капчу и включил регистрацию по email.
( #sit ) Починил иконку на новых версиях андроида. (Теперь она подчиняется системным настройкам формы иконок.)
( #sit ) Перенёс главную базу данных на PostgreSQL, тем самым создав кучу багов и ускорив приложение.
Если обнаружили баг которого раньше не было просьба написать #sit, он попробует починить в кратчайший срок.
( #sit ) Улучшения вики: перемещение, изменение порядка статей. Пофикшен баг с упоминаниями.
