...
( #NikiTank ) Новая аватарка анонима и картинка при отсутствии переводов
( #sit ) Подтверждение почты (а точнее полное переделывание входа по почте)
( #sit ) Опция не накладывать проклятие вахтёра при отклонении блокировки (@smilege)
( #sit ) Теперь от людей в чёрном списке не будут показываться публикации, комментарии, уведомления о них. Думаю не стоит уточнять, ради кого ^лично^ это сделано.
( #sit ) Фикс дублирования черновиков

При возникновении багов с входом по почте, пишите @sit или в Discord sit#1005.
Но будет вообще классно, если их не искать.
