...
( #zeon ) Теперь запросы которые принимаю как параметр изображения и прочее медиа, умеют принимать base64.
( #sit ) Возможность переместить рубрики между фэндомами (с 3.8 лвл, 1150 кармы)
( #zeon ) Теперь можно передать на сервер пустую картинку в base64, если это необходимо в запрсое
( #sit ) Очень сильно оптимизировал форматирование текста.
( #sit ) Починил приложение на Android 12
