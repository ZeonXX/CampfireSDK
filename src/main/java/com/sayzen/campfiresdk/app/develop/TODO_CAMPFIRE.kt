...
( #sit ) Теперь уведомления не будут использовать сервисы Google, когда приложение открыто. (Иначе говоря, сообщения должны приходить быстрее. Если заметил баг или краш, связанный с этим — пиши Ситу.)
( #sit ) Шок! Теперь надпись "Все эстафеты" будет видна всегда (@post_4714543)
( #sit ) При игноре будут игнорироваться упоминания
