...
( #sit ) Фикс одновременного открытия меню в фэндомах. (@post_4242623)
( #sit ) Разделитель строки теперь отделяет слова в матфильтре.
( #sit ) Фикс таблиц: изображения теперь можно увидеть, после многократного редактирования таблица не блокируется. (@post_4697753)
( #sit ) Фикс невозможности прокручивать в редакторе переводов. (@post_3673734)
( #sit ) Фикс упоминаний (теперь игнорирует большие и маленькие буквы).
( #sit ) Фикс сброса оценки лучшего комментария при раскрытии поста. (@post_3792333)
