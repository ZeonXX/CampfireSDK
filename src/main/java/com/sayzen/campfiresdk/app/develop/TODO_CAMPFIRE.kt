...
----------------------------------------------------------------------------------------------------------------------------------------------
    ...
    Во первых, хочу сказать ему большео спасибо за огромный вклад в развите проекта, во вторых, уверен что сами пользователи больше меня будут благодарны. :)
    Самое главное что показывает это обновление - Campfire может эффективно доробатываться сообществом и этому нет никаких помех.
    По поводу безопасности и переживаний некоторых, о том что они наговнкодят - разумеется прежде чем попасть в приложение/сервер, код проверяется мной, я помогу исправить ошибки.
    ...
    Не бойтесь пробовать, ваш вклад может быть любым, от добвления новых страниц в создание постов, до выравнивание дизайна кнпоки на какомнибудь экране, можете создавать новые коробки или квесты, главное чтобы вам самим было итересно.
    ...
    (#sit) Страница кода, без форматирования и с моноширным щрифтом.
    ...
    (#zeon) Значительно усилина защита паролей для пользователей которые используют email для авторизации (Регистрация новых аккаунтов по email по прежнему не доступна, но можно добавить в качестве альтернативного способа входа в существующий аккаунт). Старые аккаунты будут не доступны (их 5), напшите мне если актуально, поменяю пароль.
    (#sit) Красивые уведомления из чата, с аватарками и возможностью ответить.
