...
Фиксы предыдущего обновления:
- Цитирование сообщений
- Произвольный выход из акка по почте (надеюсь)
- Должны показываться более подробные сообщения об ошибках при входе по почте

Фикс веба скоро. -sit

Вспомнил мем где Байден прочитал с телесуфлёра действия, которые не надо было говорить.
Я вот тут и сожу как для президента эти речи пишу.
