...
(#sit) Починил поиск фэндомов и пользователей и дочинил уведомления о сообщениях на Android 12
(#sit) Вроде починил иконку на старых версиях Android (@Warden)
(#sit) Шок! Теперь видео открывается как ссылка.
(#sit) Новые консоли в геймнг фэндомах
