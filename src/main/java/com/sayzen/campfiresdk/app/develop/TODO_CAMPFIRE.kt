...
(@sit) Перемещение рубрик между фэндомами
(@sit) Просмотр проголосовавших в опросе
(@sit) Попытки починить вход по почте (экран загрузки)
(@sit) Индикатор "подписан(а) на вас" в профиле
(@sit @AbuirTheUndying) Люди в бане теперь не могут подписываться на других
(@sit) Выбор языка на лонгтап при выборе фэндома
