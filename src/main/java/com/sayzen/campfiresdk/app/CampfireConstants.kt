...
object CampfireConstants {
    ...
    fun getLvlImage(lvl: Long): Long {
        return when (lvl / 100) {
            ...
            else -> API_RESOURCES.IMAGE_BACKGROUND_LEVEL_15
        }
    }
