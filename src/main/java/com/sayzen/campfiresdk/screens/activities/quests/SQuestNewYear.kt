...
class SQuestNewYear : SQuest() {
    ...
    fun createQuest() {
        ...
        addQuest(
                QuestItem("0")
                        .setOnStart { globalLabel = "Вступление"; globalImage = API_RESOURCES.QUEST_NEW_YEAR_5 }
                ...
                QuestItem("0_1")
                        ...
                        .addButton("Это как бесконечное лето?") { to("0_2") },
                QuestItem("0_2")
        ...
        addQuest(
                QuestItem("1")
                        .setOnStart { globalLabel = "Глухой лес, утро";globalImage = API_RESOURCES.QUEST_NEW_YEAR_1 }
        ...
        addQuest(
                ...
                QuestItem("5")
                        .setOnStart { globalImage = API_RESOURCES.QUEST_NEW_YEAR_3; globalLabel = "Каменные ворота, день" }
                ...
                QuestItem("5_3_2")
                        ...
                        .addButtonParams("Применить палку") { to("5_3_3") }.enabled { stick }.finish()
        ...
        addQuest(
                QuestItem("6")
                        .setOnStart { globalImage = API_RESOURCES.QUEST_NEW_YEAR_4; globalLabel = "Алтарь, вечер" }
                ...
                QuestItem("6_1_3")
                        .setOnStart { stopThunder(); RProjectGetEffect(API.EFFECT_INDEX_HATE).send(api) }
                ...
                QuestItem("6_4")
                        ...
                        .addButtonParams("Увесистая палка (50)") { to("6_4_1") }.enabled { ControllerApi.account.getKarma30() >= 50 }.finish()
                        .addButtonParams("Двуручный меч (180)") { to("6_4_2") }.enabled { ControllerApi.account.getKarma30() >= 180 }.finish()
                        .addButtonParams("Посох тайн (355)") { to("6_4_4") }.enabled { ControllerApi.account.getKarma30() >= 355 }.finish(),
                QuestItem("6_4_1")
        ...
        addQuest(
                ...
                QuestItem("7_3")
                        ...
                        .addButton("Направиться к дому") { to("7_4") },
                QuestItem("7_4")
                        .setOnStart { globalImage = API_RESOURCES.QUEST_NEW_YEAR_5;globalLabel = "Дом старосты, вечер" }
        ...
        addQuest(
                QuestItem("8")
                        .setOnStart { startThunder(); globalImage = API_RESOURCES.QUEST_NEW_YEAR_6 }
                        ...
                        .addButton("В бой") { to("8_1") },
                QuestItem("8_1")
                        .text("Волк готовится совершить рывок...")
                        .addButton("Защищаться") { to("8_1_1") }
                        .addButton("Нанести удар") { to("8_1_2") },
                QuestItem("8_1_1")
                        .text("Вы закрываетесь руками и присидаете. Волк пргыет на вас, но ему не удается даже зацепить вас.")
                        .addButton("Атаковать в ответ") { to("8_2") }
                        .addButton("Попытаться бежать") { to("8_3") },
                QuestItem("8_1_2")
                        ...
                        .addButton("Атаковать в ответ") { to("8_2") }
                        .addButton("Попытаться бежать") { to("8_1_3") },
                QuestItem("8_1_3")
                        ...
                        .addButton("Увернуться") { to("8_1_5") }
                        .addButton("Атаковать в ответ") { to("8_1_4") },
                QuestItem("8_1_4")
                        ...
                        .addButton("Громко плакать") { to("8_4") },
                QuestItem("8_1_5")
                ...
                QuestItem("8_2")
                        ...
                        .addButton("Бить в открытый живот") { to("8_5") }
                        .addButton("Ударить в голову") { to("8_5") },
                QuestItem("8_3")
        ...
        addQuest(
                QuestItem("9")
                        .setOnStart { stopThunder(); globalImage = API_RESOURCES.QUEST_NEW_YEAR_5 }
                        .text("Теперь, когда бой закончен, а опасность миновала самое время получше осмотреться вокруг.")
                        .addButton("Осмотреть двор") { to("9_3") }
                        .addButton("Осмотреть сарай") { to("9_2") }
                        .addButton("Осмотреть дом") { to("9_1") },
                QuestItem("9_1")
                        ...
                        .addButton("Присмотреться") { to("9_1_1") },
                QuestItem("9_1_1")
                        ...
                        .addButtonParams("Осмотреть двор") { to("9_3") }.visible { !item_9_3_showed }.finish()
                        .addButtonParams("Осмотреть сарай") { to("9_2") }.visible { !item_9_2_showed }.finish(),  //  (Переход к слайду 5)
                QuestItem("9_2")
                        ...
                        .addButton("Заглянуть в курятник") { makeThunderBig();makeDarknes { to("9_2_1") } }
                        .addButtonParams("Осмотреть двор") { to("9_3") }.visible { !item_9_3_showed }.finish()
                        .addButtonParams("Осмотреть дом") { to("9_1") }.visible { !item_9_1_showed }.finish(),
                QuestItem("9_2_1")
                ...
                QuestItem("9_3")
                        ...
                        .addButton("Пойти по следу") { to("9_4") },
                QuestItem("9_4")
                        ...
                        .addButton("Идти дальше") { to("9_5") },
                QuestItem("9_5")
                        .setOnStart { globalImage = API_RESOURCES.QUEST_NEW_YEAR_7;globalLabel = "Лес, расвет" }
                        ...
                        .addButton("Взять себя в руки") { to("9_6") },
                QuestItem("9_6")
                        .text("Вы быстро движетесь по кровавому следу в лес, ноги чуть ли не по колено проваливаются в снег, солнце уже начало садиться. В броне бежать тяжело, но другого выхода нет.\n\n" +
                        ...
                        .addButton("Пойти направо") { to("9_7") }
                        .addButton("Пойти налево") { to("9_7") },
                QuestItem("9_7")
                        ...
                        .addButton("Попытаться рассмотреть") { to("9_7_1") }
                        .addButton("Спрятаться за деревом") { to("9_7_2") }
                        .addButton("«Эй ты! Я вооружён, тебе некуда бежать!»") { to("9_7_3") },
                QuestItem("9_7_1")
                ...
                QuestItem("9_7_2")
                        ...
                        .addButton("Приготовиться") { to("9_8") },
                QuestItem("9_7_3")
                        ...
                        .addButton("Приготовиться") { to("9_8") },
                QuestItem("9_8")
                        .text("Прямо на вас из-за деревьев выбежал удивительный человек. Если бы этот человек был в полушубке или в доспехах и держал в руках топор или меч, вы бы не раздумывая хладнокровно прикончили его.\n\n" +
                        ...
                        .addButton("Увернуться") { to("9_9") },
                QuestItem("9_9")
                        .text("Ничего не оставалось, как попытаться увернуться. Вы отпрыгнули и свалились в снег. Копьё, быстро набирая скорость, пронеслось над вашей головой и улетело в сторону леса.\n\n" +
        ...
        addQuest(
                QuestItem("10")
                        .setOnStart { globalImage = API_RESOURCES.QUEST_NEW_YEAR_8; globalLabel = "Лес, утро" }
                ...
                QuestItem("10_1")
                        ...
                        .addButton("Отдохнуть и осмотреться вокруг") { to("10_2") },
                QuestItem("10_2")
                        ...
                        .addButton("Осмотреться вокруг в поисках оружия") { to("10_3") },
                QuestItem("10_3")
                        ...
                        .addButton("«Что вам надо? Кто вы?»") { to("10_4") }
                        .addButton("«Где староста? Зачем он вам?!»") { to("10_4") }
                        .addButton("Промолчать") { to("10_4") },
                QuestItem("10_4")
                        ...
                        .addButton("Не показывать слабость") { to("10_5") },
                QuestItem("10_5")
                        ...
                        .addButton("Продолжать идти") { to("10_6") },
                QuestItem("10_6")
                        ...
                        .addButton("Обернуться на визг") { to("10_7") },
                QuestItem("10_7")
                        ...
                        .addButton("Рассмотреть людей") { to("10_8") }
                        .addButton("Рассмотреть их оружие") { to("10_9") }
                        .addButton("Ненавижу свиней!") { to("10_7_1") },
                QuestItem("10_7_1")
                        .text("Свинья замерла и пристально на вас посмотрелка. Вам кажется что она прчитала ваши мысли.")
                        .addButton("Извиниться") { to("10_7_3") }
                        .addButton("Мерзкое созданий!") { to("10_7_2") },
                QuestItem("10_7_2")
                ...
                QuestItem("10_9")
                        ...
                        .addButton("Ждать удачного момента") { to("10_10") },
                QuestItem("10_10")
                        .text("Очень шумно. Голова всё также болит. Вы ощупываете голову — там огромная мягкая шишка, а на шлеме сильная вмятина.\n\n" +
                        ...
                        .addButton("Разглядеть здоровяков рядом") { to("10_11") }
                        .addButton("Попытаться понять о чём они говорят") { to("10_12") },
                QuestItem("10_11")
                        ...
                        .addButton("Осмотреться") { to("10_13") },
                QuestItem("10_12")
                ...
                QuestItem("10_13")
                        ...
                        .addButton("Поддаться") { to("10_14") }
                        .addButton("Попытаться вырваться") { to("10_15") },
                QuestItem("10_14")
                        ...
                        .addButton("Начать толкать") { to("10_17") }
                        .addButton("«Ты что? Псих? Он размером с замок!»") { to("10_16") },
                QuestItem("10_15")
                ...
                QuestItem("10_17")
                        ...
                        .addButton("Продолжить толкать") { to("10_18") },
                QuestItem("10_17")
                        .setOnStart { makeThunderBig() }
                ...
                QuestItem("10_20")
                        ...
                        .addButton("Поднять его") { to("10_21") },
                QuestItem("10_21")
                        .setOnStart { makeThunderBig() }
                        ...
                        .addButton("Бороться") { makeDarknes { to("11") } }
        )
        ...
        addQuest(
                QuestItem("11")
                        .setOnStart { globalImage = API_RESOURCES.QUEST_NEW_YEAR_10; globalLabel = "Дом старосты, утро" }
                ...
                QuestItem("11_1")
                        ...
                        .addButton("«Почему же плохо? Наоборот! Открытие! Это же новый вид монстров!»") { to("11_2") },
                QuestItem("11_2")
                        .text("«Н-да-а» — неопределенно прогудел Староста, отводя глаза и наливая в блюдце чай. И Вы продолжили говорить:\n\n" +
                        ...
                        .addButton("Бороться с болью") { to("11_3") },
                QuestItem("11_3")
                ...
                QuestItem("11_5")
                        ...
                        .addButton("«А окно разбитое? А кровь?»") { to("11_6") },
                QuestItem("11_6")
                        ...
                        .addButton("«Ничего не понимаю.»") { to("11_7") },
                QuestItem("11_7")
                ...
                QuestItem("11_10")
                        ...
                        .addButton("Лечь на кровать и попытаться уснуть") { to("11_11") },
                QuestItem("11_11")
        ...
        addQuest(
                QuestItem("12")
                        ...
                        .addButton("Повторить квест") { to("0") }
        )
